...
** Write the Padframe Configuration File  
  ...
  folder to become familiar with the syntax and read the [[https://iis-people.ee.ethz.ch/~meggiman/tools/padrick-doc][documentation]].
...
* Documentation
  ...
  site at [[https://iis-people.ee.ethz.ch/~meggiman/tools/padrick-doc]].
